...
\instructions{
\begin{itemize}
\item Provide a draft `\textbf{plan for the dissemination and exploitation of
the project's results}'. Please note that such a draft plan is an admissibility
condition, unless the work programme topic explicitly states that such a plan is
not required.
\\
...
\textit{As of the Work Programme 2017 actions under Horizon 2020 participate in
...
\subsection[Communication activities]{Communication activities\instructions{\footnote{Not
applicable to SME Instrument, phase 1.}}}
\label{sec:communication}

\instructions{
\begin{itemize}
\item Describe the proposed communication measures for promoting the project and
its findings during the period of the grant\footnote{For further guidance on
communicating EU research and innovation guidance for project participants,
please refer to the H2020 Online Manual on the Participant Portal.}. Measures
